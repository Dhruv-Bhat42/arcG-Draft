...
Using arc(G) user has the ability to:
- Define any finite group G of reasonably low order
- View the overview of 
- View the fusion ring of Rep(G)
- View explicit unitary irreducible representations
- View non-trivial F matrices
...
## Sample Output
- Rep(A_4) is the smallest category with multiplicities. All arcG output, including F matrices, is available here ```Insert Link```
- Sample output on representation categories of a variety of finite groups is available here ```Insert Link```
- A list of Representation Categories with Multiplicities is available here ```Insert Link```
